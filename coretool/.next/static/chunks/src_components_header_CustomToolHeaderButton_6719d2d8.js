...
"[project]/src/components/header/CustomToolHeaderButton.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const CustomToolHeaderButton = ()=>{
    _s();
    const { setMode } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$styles$2f$ThemeProviderWithVars$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useColorScheme"])();
    const handleThemeChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CustomToolHeaderButton.useCallback[handleThemeChange]": (event)=>{
            setMode(event.target.value);
        }
    }["CustomToolHeaderButton.useCallback[handleThemeChange]"], [
        setMode
    ]);
    ...
    const toggleMenu = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CustomToolHeaderButton.useCallback[toggleMenu]": (event)=>{
            setMenuAnchorEl(isMenuOpen ? null : event.currentTarget);
            setIsMenuOpen({
                "CustomToolHeaderButton.useCallback[toggleMenu]": (previousIsMenuOpen)=>!previousIsMenuOpen
            }["CustomToolHeaderButton.useCallback[toggleMenu]"]);
        }
    }["CustomToolHeaderButton.useCallback[toggleMenu]"], [
        isMenuOpen
    ]);
...
_s(CustomToolHeaderButton, "ltSSaBCkB+FmggqGpJX2NXnXtJ0=", false, function() {
    return [
...
_c = CustomToolHeaderButton;
const __TURBOPACK__default__export__ = CustomToolHeaderButton;
var _c;
__turbopack_context__.k.register(_c, "CustomToolHeaderButton");
...
//# sourceMappingURL=src_components_header_CustomToolHeaderButton_6719d2d8.js.map